...
para que eu nao tenha que esperar em uma fila do banco.
  ...
  @tag1
  Scenario: Cliente especial com saldo negativo realizando saque
    Given um cliente é especial com saldo atual de -200 reais
  ...
  Scenario Outline: Cliente comum com saldo negativo
    ...
    Examples: 
      | nome      | saldo | saque_valor | saldo_atual | status  |
      | especial  | -200  | 		100     |    -300     | sucesso |
      | comum     | -200  | 		200   	|    -200     | falha   |
